...
function columns( $atts, $content = null ) {
    $a = shortcode_atts( array(
        'width' => 'm-all s-all t-all d-all dl-all xl-all',
        'extra' => '',
    ), $atts );

    $clean = copter_remove_crappy_markup($content);
    return '<div class="' . $a['width'] . ' ' . $a['extra'] .'">' . do_shortcode($clean) . '</div>';
}
...
function add_plugin( $plugin_array ) {
   $plugin_array['column'] = get_template_directory_uri() . '/library/js/column.js';
   return $plugin_array;
}

function column_button() {
...
add_action('init', 'column_button');



/* Clean up the paragraph tags around shortcodes */
...
/* Add language selection to menu. Just uncomment when needed. */
/*
